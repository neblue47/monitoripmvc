...
//				System.out.println("P1: "+logs[0]+" P2: "+logs[1]);
...
//				System.out.println(e.toString());
	...
	public ListaBean serialEventos(SerialPortEvent oEvent) {
