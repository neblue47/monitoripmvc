 ...
 <div class="row">
		<div class="col-md-7" >			
			 <c:if test="${not empty armarios}">		
				  ...
				  <h5><i class="fa fa-th"></i> Lista de Módulos do Sistema</h5>
				  <table id="table" data-toggle="table" data-height="468" data-pagination="true" data-search="true">
					   <thead>
							<tr>
								<th data-field="#" data-align="left">#</th>
								<th data-field="Descricao" data-align="left"> Designação </th>
	  ...
	  <div class="col-md-5">
		   <form method="post" action="SensorController">
     			 <div class="widget-title pesAdmin">
     			 	  <h5><i class="fa fa-th"></i> Novo / Editar Módulo </h5>
     			 	  <div id="agenda-perfil">     			 
	        			  ...
	        			  <div class="form-group input-group input-group-addon-ajust ">
	        				 	<span class="input-group-addon"> Codigo Módulo : </span>	            			
	            			 	<input class="form-control" name="desc" type="text" value="${posto.nomPosto }"  required="required"/>
	        			  </div>
