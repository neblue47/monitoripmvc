	...
	<div class="col-md-4">
		<div class="widget-title widget-btn">
			<form name="triados">		     
			     ...
			     <input type="button" value="Mensal" class="btn btn-primary btn-block btn-active-proc" data-toggle="button" onclick="mensal();">
	...
	<c:if test="${empty listaLogs }">
			...
			<div class="col-md-12">
			 	<div class="widget-title">
			 		<h5><i class="fa fa-tasks"></i> Emitir Relatorio - Mensal </h5>
			 		<div id="agenda-perfil">
	                    ...
	                    <input class="form-control" id="armario" name="armario">
		           		</div>
			     		 <div class="form-group input-group input-group-addon-ajust">
				...
				<input type="hidden" name="pesquisar" value="rtm">	
	 ...
	 <div class="row">
	  ...
	  <div class="widget-title">			 			  
				...
				<div class="pull-right">
					<a href="navegacao?mod=ag&pesquisar=rtm"  class="btn btn-default btn-sm"  >
